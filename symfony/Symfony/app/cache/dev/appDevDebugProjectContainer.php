...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d = new \Symfony\Bridge\Doctrine\Mapping\Driver\YamlDriver(array(0 => '/var/www/aceduino/symfony/Symfony/src/Ace/EditorBundle/Resources/config/doctrine'));
        $d->setNamespacePrefixes(array('/var/www/aceduino/symfony/Symfony/src/Ace/EditorBundle/Resources/config/doctrine' => 'Ace\\EditorBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Ace\\EditorBundle\\Entity');
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(new \Symfony\Bridge\Doctrine\Annotations\IndexedReader($this->get('annotation_reader')), array(0 => '/var/www/aceduino/symfony/Symfony/src/Ace/UserBundle/Entity')), 'Ace\\UserBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('AceEditorBundle' => 'Ace\\EditorBundle\\Entity', 'AceUserBundle' => 'Ace\\UserBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/var/www/aceduino/symfony/Symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $f = new \Symfony\Component\HttpFoundation\RequestMatcher('^/list/*');

        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/edit/*');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/options/*');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/create/*');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin');

        $k = new \Symfony\Component\Security\Http\AccessMap();
        $k->add($f, array(0 => 'ROLE_USER'), NULL);
        ...
        $l = new \Symfony\Component\Security\Core\User\InMemoryUserProvider();
        $l->createUser(new \Symfony\Component\Security\Core\User\User('user', 'userpass', array(0 => 'ROLE_USER')));
        $l->createUser(new \Symfony\Component\Security\Core\User\User('tzikis', 'qwerty', array(0 => 'ROLE_USER')));
        $l->createUser(new \Symfony\Component\Security\Core\User\User('admin', 'adminpass', array(0 => 'ROLE_ADMIN')));

        $m = new \Symfony\Component\Security\Http\HttpUtils($d);

        $n = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $m, '/logout', '/home', NULL);
        $n->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.administrators'), 1 => $l), 'secured_area', $a, $c), 2 => $n, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $e, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $m, 'secured_area', array('check_path' => '/login_check', 'login_path' => '/login', 'use_forward' => false, 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false, 'failure_path' => NULL, 'failure_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), NULL, NULL, $a, $c), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '4f42833df27cd', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $k, $e, $a)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $m, new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($this->get('http_kernel'), $m, '/login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => '/var/www/aceduino/symfony/Symfony/app/cache/dev/translations', 'debug' => true), $this->get('session'));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.administrators'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine.orm.default_entity_manager'), 'AceUserBundle:User', NULL);
    }
